...
classes = {}
"""
this is an empty directory that will have collection of all key,
value pairs
...
class BaseModel:
    """
    This is the maon base model for the project, the other classes
    will be calling this
    """
    def __init__(self, *args, **kwargs):
        """
        Initializes a new instance of the BaseModel class with the
        provided arguments.
